...
public class MlssAdapter extends RecyclerView.Adapter<MlssAdapter.MyViewHolder>{
    Context context;
    List<ShopEntity.ResultBean.MlssBean.CommodityListBeanXX> commodityList;
    public MlssAdapter(Context context, List<ShopEntity.ResultBean.MlssBean.CommodityListBeanXX> commodityList) {
