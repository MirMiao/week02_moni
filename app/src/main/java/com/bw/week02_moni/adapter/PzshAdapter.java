...
public class PzshAdapter extends RecyclerView.Adapter<PzshAdapter.MyViewHolder>{
    Context context;
    List<ShopEntity.ResultBean.PzshBean.CommodityListBeanX> commodityList;

    public PzshAdapter(Context context, List<ShopEntity.ResultBean.PzshBean.CommodityListBeanX> commodityList) {
